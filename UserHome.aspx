<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserHome.aspx.cs" Inherits="TourAndTravel2.UserHome" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <section class="hero">
            ...
            <asp:Button ID="logoutBtn" runat="server" Text="Logout" CssClass="logOutButton" OnClick="LogOutButton_Click" BorderColor="Transparent" BorderStyle="None" ForeColor="White" />
            ...
            <div class="hero-content-area">
                <h1>
                    <asp:Label ID="userNameLabel" runat="server" Text="Label"></asp:Label></h1>
                <h3>Get Ready for Unmissable Adventure Tours Around The World</h3>
                <asp:Button ID="packageButton" runat="server" Text="Check Packages" CssClass="checkButton" OnClick="packageButton_Click" BorderColor="Transparent" BorderStyle="None" ForeColor="White" />
                ...
                <%--                   <asp:Button ID="CheckoutButton" runat="server" Text="Checkout" CssClass="checkoutButtonHome" OnClick="CheckoutButton_Click" BorderColor="Transparent" BorderStyle="None" ForeColor="White" />--%>

                <%--                   <asp:Button ID="BookingButton" runat="server" Text="Bookings" CssClass="bookingsButtonHome" OnClick="BookingButton_Click" BorderColor="Transparent" BorderStyle="None" ForeColor="White" />--%>
            </div>
        </section>
